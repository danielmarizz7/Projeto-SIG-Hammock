...
//Fgets trocar o \n pelo \0
//retorna o tamanho e coloca o /0 na ultima posicao da string
//Criar input?
//Fazer a questão da leitura (3 etapas)
//Etapa 1: Ler os dados; Etapa 2: Validar os dados; Etapa 3: Gravar no arquivo;
